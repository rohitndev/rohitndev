...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Detects coordinated payment fraud in real time using graph analytics, streaming pipelines, ensemble ML, and autonomous AI investigations.</td>
    ...
    <tr>
      ...
      <td>Implements a modern Data Mesh with federated governance, enabling cross-domain SQL queries without ETL or data movement.</td>
    ...
    <tr>
      ...
      <td>Builds a real-time Industrial IoT Lakehouse using Medallion Architecture for OEE monitoring, anomaly detection, and predictive analytics.</td>
    ...
    <tr>
      ...
      <td>Creates a unified Customer 360 platform using CDC, identity resolution, and Medallion Architecture for real-time customer intelligence.</td>
    ...
    <tr>
      ...
      <td>Predicts industrial equipment failures using Temporal Fusion Transformers, Anomaly Transformers, and explainable AI.</td>
      <td>Temporal Fusion Transformer · Anomaly Transformer · PyTorch · SHAP · FastAPI</td>
    </tr>

    <tr>
      <td><a href="https://github.com/rohitndev/Autonomous-ESG-Intelligence-Platform-with-GraphRAG"><b>Autonomous ESG Intelligence Platform (GraphRAG)</b></a></td>
      <td>Delivers AI-powered ESG analysis using GraphRAG, Knowledge Graphs, multi-hop reasoning, and automated sustainability reporting.</td>
    ...
    <tr>
      ...
      <td>Correlates logs, detects anomalies, identifies root causes, and automates incident investigation using AI agents and RAG.</td>
